  ...
  renderUsedAndFuelSection() {
    ...
    return `
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--space-3);">
        ...
        <button class="btn-glass small" onclick="AppMarket.refreshUsedMarket(); AppMarketHub.renderView();">Обновить</button>
      </div>
  ...
  renderHRSection() {
    ...
    return `
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--space-3);">
        ...
        <button class="btn-glass small" onclick="AppDrivers.generateCandidatesPool(6); AppMarketHub.renderView();">Обновить</button>
      </div>
